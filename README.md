...
3. Open this notebook: [My_first_python_notebook.ipynb](My_first_python_notebook.ipynb) [![Open In Colab](https://colab.research.google.com/github/hernanmorales-navarrete/DataAnalysisWithPython/blob/main/My_first_python_notebook.ipynb)
